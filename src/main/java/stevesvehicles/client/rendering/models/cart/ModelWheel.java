...
public class ModelWheel extends ModelVehicle {
	...
	public ModelWheel() {
		...
		bottomLeft.addBox(-1F, // X
				...
				2, // Size Z
				0.0F);
		bottomLeft.setRotationPoint(0, // X
				3, // Y
				-5.5F // Z
				);
		...
		bottomRight.addBox(-1F, // X
				...
				2, // Size Z
				0.0F);
		bottomRight.setRotationPoint(0, // X
				3, // Y
				5.5F // Z
				);
		...
		bottomInnerLeft.addBox(-1F, // X
				...
				2, // Size Z
				0.0F);
		bottomInnerLeft.setRotationPoint(0, // X
				5, // Y
				-3.5F // Z
				);
		...
		bottomInnerRight.addBox(-1F, // X
				...
				2, // Size Z
				0.0F);
		bottomInnerRight.setRotationPoint(0, // X
				5, // Y
				3.5F // Z
				);
		...
		middleBottom.addBox(-0.5F, // X
				...
				1, // Size Z
				0.0F);
		middleBottom.setRotationPoint(0.5F, // X
				3.5F, // Y
				0F // Z
				);
		...
		middle.addBox(-1.5F, // X
				...
				1, // Size Z
				0.0F);
		middle.setRotationPoint(0.5F, // X
				0F, // Y
				0F // Z
				);
		...
		middleLeft.addBox(-1.5F, // X
				...
				1, // Size Z
				0.0F);
		middleLeft.setRotationPoint(0.5F, // X
				-1F, // Y
				-3F // Z
				);
		...
		middleRight.addBox(-1.5F, // X
				...
				1, // Size Z
				0.0F);
		middleRight.setRotationPoint(0.5F, // X
				-1F, // Y
				3F // Z
				);
		...
		innerLeft.addBox(-1.5F, // X
				...
				1, // Size Z
				0.0F);
		innerLeft.setRotationPoint(0.5F, // X
				-1.5F, // Y
				-5F // Z
				);
		...
		innerRight.addBox(-1.5F, // X
				...
				1, // Size Z
				0.0F);
		innerRight.setRotationPoint(0.5F, // X
				-1.5F, // Y
				6F // Z
				);
