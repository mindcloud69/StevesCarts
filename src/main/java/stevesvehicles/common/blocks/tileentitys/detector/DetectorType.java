...
import stevesvehicles.common.blocks.BlockRailAdvancedDetector;
...
public enum DetectorType implements IRecipeOutput, IStringSerializable {
	NORMAL(0, true, false, true, "detectors/manager/bot", "detectors/manager/top", "detectors/manager/yellow", "detectors/manager/blue", "detectors/manager/green", "detectors/manager/red"),
	UNIT(1, false, false, false, "detectors/unit/bot", "detectors/unit/bot", "detectors/unit/yellow", "detectors/unit/blue", "detectors/unit/green", "detectors/unit/red"),
	STOP(2, true, true, false, "detectors/station/bot", "detectors/station/top", "detectors/station/yellow", "detectors/station/blue", "detectors/station/green", "detectors/station/red") {
		@Override
		public void activate(TileEntityDetector detector, VehicleBase vehicle) {
			((EntityModularCart) vehicle.getEntity()).releaseCart(); // TODO
		}
	},
	JUNCTION(3, true, false, false, "detectors/junction/bot", "detectors/junction/top", "detectors/junction/yellow", "detectors/junction/blue", "detectors/junction/green", "detectors/junction/red") {
		@Override
		public void activate(TileEntityDetector detector, VehicleBase vehicle) {
	...
	REDSTONE(4, false, false, false, "detectors/redstone/bot", "detectors/redstone/top", "detectors/redstone/yellow", "detectors/redstone/blue", "detectors/redstone/green", "detectors/redstone/red") {
		@Override
	...
	/*
	 * public void registerIcons(IIconRegister register) { icons = new
	 * IIcon[textures.length]; for (int i = 0; i < textures.length; i++) {
	 * icons[i] = register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":" + textures[i]); } } public IIcon getIcon(int side) { return
	 * icons[side]; }
	 */
