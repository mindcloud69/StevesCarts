...
public class BlockDistributor extends BlockContainerBase {
	...
	/*
	 * private IIcon purpleIcon; private IIcon orangeIcon; private IIcon
	 * redIcon; private IIcon blueIcon; private IIcon greenIcon; private IIcon
	 * yellowIcon;
	 * @SideOnly(Side.CLIENT)
	 * @Override public IIcon getIcon(int side, int meta) { if (side == 0) {
	 * return purpleIcon; } else if (side == 1) { return orangeIcon; } else if
	 * (side == 2) { return yellowIcon; } else if (side == 3) { return blueIcon;
	 * } else if (side == 4) { return greenIcon; } else { return redIcon; } }
	 * @SideOnly(Side.CLIENT)
	 * @Override public void registerBlockIcons(IIconRegister register) {
	 * purpleIcon = register.registerIcon(StevesVehicles.instance.textureHeader
	 * + ":distributor/purple"); orangeIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":distributor/orange"); redIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":distributor/red"); blueIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":distributor/blue"); greenIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":distributor/green"); yellowIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":distributor/yellow"); }
	 */
	@Override
