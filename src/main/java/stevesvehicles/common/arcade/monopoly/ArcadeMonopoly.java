...
public class ArcadeMonopoly extends ArcadeGame {
	...
	public ArcadeMonopoly(ModuleArcade module) {
		...
		places = new Place[] { new Go(this), new Street(this, streetGroup1, "Soaryn Chest", 30, 2), new Community(this), new Street(this, streetGroup1, "Eddie's Cobble Stairs", 30, 2), new Place(this), new Utility(this, utilGroup, 0, "Test"),
				new Street(this, streetGroup2, "Ecu's Eco Escape", 60, 4), new Station(this, stationGroup, 0, "Wooden Station"), new Street(this, streetGroup2, "Test", 60, 4), new Villager(this), new Street(this, streetGroup3, "Direwolf's 9x9", 100, 6),
				new Chance(this), new Street(this, streetGroup3, "Greg's Forest", 100, 6), new Street(this, streetGroup3, "Alice's Tunnel", 110, 8), new Jail(this), new Street(this, streetGroup4, "Flora's Alveary", 140, 10),
				new Utility(this, utilGroup, 1, "Test"), new Street(this, streetGroup4, "Sengir's Greenhouse", 140, 10), new Street(this, streetGroup4, "Test", 160, 12), new Station(this, stationGroup, 1, "Standard Station"),
				new Street(this, streetGroup5, "Muse's Moon Base", 200, 14), new Community(this), new Street(this, streetGroup5, "Algorithm's Crafting CPU", 200, 14), new Street(this, streetGroup5, "Pink Lemmingaide Stand", 240, 16),
				new CornerPlace(this, 2), new Street(this, streetGroup6, "Covert's Railyard", 250, 18), new Chance(this), new Street(this, streetGroup6, "Test", 250, 18), new Street(this, streetGroup6, "Test", 270, 20), new Community(this),
				new Street(this, streetGroup6, "Test", 270, 20), new Station(this, stationGroup, 2, "Reinforced Station"), new Street(this, streetGroup7, "Player's Industrial Warehouse", 320, 22), new Villager(this),
				new Street(this, streetGroup7, "Dan's Computer Repair", 320, 22), new Street(this, streetGroup7, "iChun's Hat Shop", 350, 24), new Utility(this, utilGroup, 2, "Test"), new Street(this, streetGroup7, "Lex's Forge", 350, 24),
				new GoToJail(this), new Street(this, streetGroup8, "Morvelaira's Pretty Wall", 400, 26), new Street(this, streetGroup8, "Rorax's Tower of Doom", 400, 26), new Community(this), new Street(this, streetGroup8, "Jaded's Crash Lab", 440, 30),
				new Station(this, stationGroup, 3, "Galgadorian Station"), new Chance(this), new Street(this, streetGroup9, "Test", 500, 40), new Place(this), new Street(this, streetGroup9, "Vswe's Redstone Tower", 600, 50) };
		((Property) places[1]).setOwner(pieces.get(0));
		((Property) places[3]).setOwner(pieces.get(0));
		/*
		 * for (int i = 0; i < pieces.size(); i++) { pieces.get(i).goToJail();
						...
						if (hasDoubleDice()) {
							...
							if (getCurrentPiece().getTurnsInJail() < 3) {
								...
								if (jail.isVisible() && jail.isEnabled()) {
									...
									// TODO: Allow the bot to sell things to
					...
					if (useAI()) {
						if (purchase.isVisible() && purchase.isEnabled()) {
							...
							if (rent.isEnabled()) {
								...
								// TODO: Allow the bot to sell things to avoid
								// going bankrupt
								bankrupt.onClick();
							}
						}
	...
	public void drawBackground(GuiVehicle gui, int x, int y) {
		...
		if (selectedPlace != -1) {
			drawPropertyOnBoardWithPositionRotationAndScale(gui, places[selectedPlace], selectedPlace, true, false, (int) ((VehicleBase.MODULAR_SPACE_WIDTH / 0.75 - ((getId(selectedPlace) == 0) ? PLACE_HEIGHT : PLACE_WIDTH)) / 2),
					(int) ((VehicleBase.MODULAR_SPACE_HEIGHT / 0.75 - PLACE_HEIGHT) / 2), 0, 0.75F);
		}
		for (int i = 0; i < places.length; i++) {
			if (!foundHover && getModule().inRect((int) smallGridX, (int) smallGridY, getSmallGridPlaceArea(i))) {
				if (selectedPlace == -1) {
					drawPropertyOnBoardWithPositionRotationAndScale(gui, places[i], i, true, false, (int) ((VehicleBase.MODULAR_SPACE_WIDTH / 0.75 - ((getId(i) == 0) ? PLACE_HEIGHT : PLACE_WIDTH)) / 2),
							(int) ((VehicleBase.MODULAR_SPACE_HEIGHT / 0.75 - PLACE_HEIGHT) / 2), 0, 0.75F);
				}
				foundHover = true;
