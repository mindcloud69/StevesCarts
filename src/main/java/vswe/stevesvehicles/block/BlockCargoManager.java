...
public class BlockCargoManager extends BlockContainerBase {
	 ...
	 * ":managers/cargo/top"); botIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":managers/cargo/bot"); redIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":managers/cargo/red"); blueIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":managers/cargo/blue"); greenIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":managers/cargo/green"); yellowIcon =
	 * register.registerIcon(StevesVehicles.instance.textureHeader +
	 * ":managers/cargo/yellow"); }
	 */
	@Override
