...
public class UpgradeRegistryControl extends UpgradeRegistry {
	public UpgradeRegistryControl() {
		...
		input.addShapedRecipe(null, SIMPLE_PCB, null, Items.REDSTONE, Blocks.CHEST, Items.REDSTONE, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(input);
		Upgrade production = new Upgrade("production_line");
		production.addEffect(Blueprint.class);
		production.addShapedRecipe(null, SIMPLE_PCB, null, Items.REDSTONE, Blocks.PISTON, Items.REDSTONE, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(production);
		Upgrade deployer = new Upgrade("cart_deployer");
		deployer.addEffect(Deployer.class);
		deployer.addShapedRecipe(Items.IRON_INGOT, Blocks.RAIL, Items.IRON_INGOT, Items.REDSTONE, Blocks.PISTON, Items.REDSTONE, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(deployer);
		Upgrade modifier = new Upgrade("cart_modifier");
		modifier.addEffect(Disassemble.class);
		modifier.addShapedRecipe(Items.IRON_INGOT, null, Items.IRON_INGOT, Items.REDSTONE, Blocks.ANVIL, Items.REDSTONE, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(modifier);
		Upgrade crane = new Upgrade("cart_crane");
		crane.addEffect(Transposer.class);
		crane.addShapedRecipe(Items.IRON_INGOT, Blocks.PISTON, Items.IRON_INGOT, Items.REDSTONE, Blocks.RAIL, Items.REDSTONE, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(crane);
		...
		redstone.addShapedRecipe(Blocks.REDSTONE_TORCH, null, Blocks.REDSTONE_TORCH, Items.REDSTONE, SIMPLE_PCB, Items.REDSTONE, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(redstone);
		Upgrade manager = new Upgrade("manager_bridge");
		manager.addEffect(Manager.class);
		manager.addEffect(TimeFlatCart.class, 100);
		manager.addShapedRecipe(Items.IRON_INGOT, Blocks.PISTON, Items.IRON_INGOT, Items.REDSTONE, Blocks.RAIL, Items.REDSTONE, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(manager);
	}
}
