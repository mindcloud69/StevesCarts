...
public class UpgradeRegistryProduction extends UpgradeRegistry {
	public UpgradeRegistryProduction() {
		...
		knowledge.addShapedRecipe(Items.BOOK, Blocks.BOOKSHELF, Items.BOOK, Blocks.BOOKSHELF, Blocks.ENCHANTING_TABLE, Blocks.BOOKSHELF, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		register(knowledge);
		...
		espionage.addShapedRecipe(Blocks.BOOKSHELF, Items.IRON_INGOT, Blocks.BOOKSHELF, Items.GLOWSTONE_DUST, REINFORCED_METAL, Items.GLOWSTONE_DUST, REINFORCED_METAL, knowledge, REINFORCED_METAL);
		register(espionage);
		...
		experienced.addShapedRecipe(SIMPLE_PCB, Items.BOOK, SIMPLE_PCB, Items.IRON_INGOT, ADVANCED_PCB, Items.IRON_INGOT, Items.IRON_INGOT, BLANK_UPGRADE, Items.IRON_INGOT);
		...
		era.addShapedRecipe(EYE_OF_GALGADOR, Items.BOOK, EYE_OF_GALGADOR, Items.IRON_INGOT, SIMPLE_PCB, Items.IRON_INGOT, EYE_OF_GALGADOR, experienced, EYE_OF_GALGADOR);
		register(era);
		Upgrade demolisher = new Upgrade("quick_demolisher");
		demolisher.addEffect(TimeFlatRemoved.class, -8000);
		demolisher.addShapedRecipe(Blocks.OBSIDIAN, Items.IRON_INGOT, Blocks.OBSIDIAN, Items.IRON_INGOT, Blocks.IRON_BLOCK, Items.IRON_INGOT, Blocks.OBSIDIAN, BLANK_UPGRADE, Blocks.OBSIDIAN);
		register(demolisher);
		Upgrade entropy = new Upgrade("entropy");
		entropy.addEffect(TimeFlatRemoved.class, -32000);
		entropy.addEffect(TimeFlat.class, 500);
		entropy.addShapedRecipe(Blocks.LAPIS_BLOCK, Items.IRON_INGOT, null, Items.REDSTONE, EYE_OF_GALGADOR, Items.REDSTONE, null, demolisher, Blocks.LAPIS_BLOCK);
		register(entropy);
