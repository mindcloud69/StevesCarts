...
public class UpgradeRegistryPower extends UpgradeRegistry {
	public UpgradeRegistryPower() {
		...
		battery.addShapedRecipe(Items.REDSTONE, Items.REDSTONE, Items.REDSTONE, Items.REDSTONE, new ItemStack(Items.DYE, 1, 4), Items.REDSTONE, Items.REDSTONE, BLANK_UPGRADE, Items.REDSTONE);
		register(battery);
		Upgrade crystal = new Upgrade("power_crystal");
		crystal.addEffect(FuelCapacity.class, 15000);
		crystal.addEffect(Recharger.class, 150);
		crystal.addShapedRecipe(Items.REDSTONE, Items.GLOWSTONE_DUST, Items.REDSTONE, Items.GLOWSTONE_DUST, Blocks.LAPIS_BLOCK, Items.GLOWSTONE_DUST, Items.DIAMOND, battery, Items.DIAMOND);
		register(crystal);
		Upgrade co2 = new Upgrade("co2_friendly");
		co2.addEffect(FuelCost.class, 0.5F);
		co2.addShapedRecipe(null, Blocks.PISTON, null, SIMPLE_PCB, Blocks.IRON_BARS, SIMPLE_PCB, CLEANING_FAN, BLANK_UPGRADE, CLEANING_FAN);
		register(co2);
		...
		solar.addShapedRecipe(SOLAR_PANEL, SOLAR_PANEL, SOLAR_PANEL, Items.REDSTONE, Items.DIAMOND, Items.REDSTONE, Items.REDSTONE, BLANK_UPGRADE, Items.REDSTONE);
		register(solar);
	}
}
